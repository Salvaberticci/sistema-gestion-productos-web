...
<div class="card p-0 mb-4" style="border-top: 4px solid var(--color-danger);">
    ...
    <div class="product-cards p-3" style="display: flex; border-top: 1px solid var(--color-border);">
        <?php foreach ($pendingOrders as $o): ?>
        <div class="product-card" onclick="viewOrder(<?= $o['id'] ?>)" style="width: 100%; cursor: pointer;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="text-dim" style="font-size:0.7rem;"><?= formatCurrency($o['total_bs'], 'Bs.') ?></div>
                    </td>
